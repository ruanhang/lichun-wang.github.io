...
title:  "Faster R-CNN"
category: [algorithm ]
tags: [algorithms,caffe,object-detection]
description: Sort
...
这篇文章主要讲述Faster RCNN[^1]目标识别框架，不得不说，代码写得真心不错，调调就可以跑。
...
![image](https://github.com/saicoco/saicoco.github.io/blob/master/downloads/object_detection/faster_rcnn.png)
